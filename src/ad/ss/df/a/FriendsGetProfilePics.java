...
public class FriendsGetProfilePics {
    ...
    /*
     * set max async tasks at any given time.
     */
    final static int MAX_ALLOWED_TASKS = Config.MAX_FRIEND_LIST_PIC; 
     ...
     * else execute a new async task to fetch it - if total async tasks > max,
     * queue the request.
     */
